...
import com.ultikits.plugins.mail.i18n.UltiMailLanguageCatalogueTest.Catalogue;
 ...
 * ({@link UltiMailLanguageCatalogueTest#loadModuleCatalogues()}: the framework's own {@link Language},
...
public final class CatalogueText {
    ...
    public static Map<String, String> entries(String code) {
        try {
            for (Catalogue c : UltiMailLanguageCatalogueTest.loadModuleCatalogues()) {
